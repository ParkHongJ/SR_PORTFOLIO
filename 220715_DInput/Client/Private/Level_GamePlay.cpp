...
HRESULT CLevel_GamePlay::Initialize()
{
	...
	CGameMgr::Get_Instance()->SetFadeObj(LEVEL_STAGE1);
...
HRESULT CLevel_GamePlay::Ready_Layer_BackGround(const _tchar * pLayerTag)
{
	...
	Desc.iNumLevel = LEVEL_STAGE1;
	Desc.vPos = { 15.f,0.f,8.f };
	if (FAILED(pGameInstance->Add_GameObjectToLayer(TEXT("Prototype_GameObject_Terrain"), LEVEL_STAGE1, pLayerTag, &Desc)))
		return E_FAIL;
