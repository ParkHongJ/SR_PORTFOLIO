...
private:
	...
	_float m_fFrame;
public:
	void OnTriggerEnter(CGameObject* other, float fTimeDelta)override;
	void OnTriggerStay(CGameObject* other, float fTimeDelta)override;
	void OnTriggerExit(CGameObject* other, float fTimeDelta)override;
public:
