...
BEGIN(Client)
class CLevel_Stage8 final : public CLevel
{
private:
	CLevel_Stage8(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CLevel_Stage8() = default;
...
public:
	static CLevel_Stage8* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
