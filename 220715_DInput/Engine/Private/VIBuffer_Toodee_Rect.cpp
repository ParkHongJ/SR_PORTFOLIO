...
HRESULT CVIBuffer_Toodee_Rect::Initialize_Prototype()
{
	...
	pVertices[0].vPosition = _float3(-(1.5f / 2.f), 0.f, 1.5f);
	pVertices[0].vTexture = _float2(0.f, 0.f);

	pVertices[1].vPosition = _float3((1.5f / 2.f), 0.f, 1.5f);
	pVertices[1].vTexture = _float2(1.f, 0.f);

	pVertices[2].vPosition = _float3((1.5f / 2.f), 0.f, 0.f);
	pVertices[2].vTexture = _float2(1.f, 1.f);

	pVertices[3].vPosition = _float3(-(1.5f / 2.f), 0.f, 0.f);
